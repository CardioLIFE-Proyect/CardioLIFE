...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (acceptButton) {
        acceptButton.addEventListener('click', closeTermsModal);
    }
    ...
    // Añadir evento click a todos los enlaces de "Términos y Condiciones"
    const termsLinks = document.querySelectorAll('a[href="#"]');
    termsLinks.forEach(link => {
        // Verificar si el texto del enlace contiene "Términos" o "Condiciones"
    ...
    // Opcionalmente, añadir manejo de tecla ESC para cerrar
